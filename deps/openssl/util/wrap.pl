...
BEGIN {
    ...
    require '/Users/jackie.ou/Desktop/Research/dev/mediasoup-server/deps/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/jackie.ou/Desktop/Research/dev/mediasoup-server/deps/openssl/test/fips-and-base.cnf';
    shift;
